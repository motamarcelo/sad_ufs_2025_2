...
Esta seção detalha o desenvolvimento de um protótipo funcional (MVP) que integra dados urbanos de Aracaju em dashboards e mapas interativos. Utiliza a arquitetura Visão-Modelo 4+1 para estruturar a lógica, componentes e processos do sistema, permitindo a simulação de cenários de intervenção. Além disso, define os requisitos funcionais e não-funcionais voltados para otimizar a tomada de decisão estratégica.
...
Esta seção apresenta o planejamento temporal e financeiro, estruturado em um cronograma de 12 semanas dividido em cinco fases iterativas. Inclui a análise de riscos técnicos e uma estimativa de custos totais de 72 mil reais para cobrir equipe, infraestrutura de nuvem e licenças. O financiamento foca em editais de inovação e parcerias institucionais para viabilizar a execução.
