...
\author{Beathriz Laurent Carlos Muniz\inst{1}, Jeferson de Oliveira Santos\inst{2}, \\Nome do Autor Quatro\inst{3}, Marcelo Pedral Mota\inst{4}, \\Niceu Santos Biriba\inst{5}, Gilton José Ferreira da Silva\inst{2} } 
...
\address{Departamento de Computação (DCOMP)\\ Universidade Federal de Sergipe
  ...
  \email{autor03@dcomp.ufs.br, marcelo.mota@dcomp.ufs.br}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/diagramas/diagrama_de_classes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/diagramas/diagrama_de_componentes.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/diagramas/diagrama_de_atividades.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/diagramas/diagrama_de_implantacao.png}
...
\begin{figure}[H]
\centering
\includegraphics[width=\textwidth]{images/diagramas/diagrama_de_casos_de_uso.png}
...
\begin{itemize}
  ...
  \item Nome do Autor Três: Definição da arquitetura de software do projeto, elaboração dos diagramas e descrição das visões arquiteturais (lógica, desenvolvimento, processo, física e casos de uso), garantindo a viabilidade técnica da solução proposta;
